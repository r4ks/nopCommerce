namespace Nop.Plugin.Widgets.HumanResource.Web.Infrastructure
{
    ...
    {
        public static string HumanResourceSettingsDetailsBlock => "admin_hr_settings_details_block";
        public static string HumanResourceSettingsButtons => "admin_hr_settings_buttons";
        ...
        public static string EmployeeTemplateListButtons => "admin_employee_template_list_buttons";
    }
}